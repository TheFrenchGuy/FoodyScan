...
class ScannerViewModel: ObservableObject {
    ...
    init() {
         self.lastQrCode = UserDefaults.standard.object(forKey: "lastQrCode") as? String ?? "first scan" //"3252210390014" //To initialiased the QR code to be saved and if there is an error then the field will be "not scanned"
    }
