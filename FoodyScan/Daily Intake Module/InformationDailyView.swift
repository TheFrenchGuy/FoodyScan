                            ...
                            ScrollView(.horizontal, showsIndicators: false) { //So that on all iphone device the view looks great and so more information can be seen
                               // GeometryReader { geometry in
                                    HStack {
                                        ...
                                        CalorieChartIntake(CaloriePieData: CaloriePieData, lefttoeat: lefttoeat, lefteatpercentage: lefteatpercentage, eatencalpercentage: eatencalpercentage, isOverCal: isOverCal)
                                        
                                        CalorieDailyIntake(lefttoeat: lefttoeat, CaloriePieData: CaloriePieData, isOverCal: isOverCal)
                                        
                                        
                                        SugarChartIntake(SugarPieData: SugarPieData, leftsugar: leftsugar, leftsugarpercentage: leftsugarpercentage, eatensugarpercentage: eatensugarpercentage, isOverSugar: isOverSugar)
                                            
                                        SugarDailyIntake(SugarPieData: SugarPieData, leftsugar: leftsugar, leftsugarpercentage: leftsugarpercentage, eatensugarpercentage: eatensugarpercentage, isOverSugar: isOverSugar)
                                    ...
                                    VStack {
                                        Color(self.colorScheme == .light ? .black: .white)
                                            .mask(Image("Salt")
                                                .resizable())
                                            .frame(width: 40, height: 40)
                                        Text("Salt: \(eatenToday.saltToday, specifier: "%0.f") g")
                                    }
                                    .shadow(color: Color("LightShadow"), radius: 12, x: -12, y: -12)
                                    .shadow(color: Color("DarkShadow"), radius: 12, x: 12, y: 12)
                                    .padding(10)
                                    ...
                                    VStack {
                                        Color(self.colorScheme == .light ? .black: .white)
                                            .mask(Image("Fat")
                                                .resizable())
                                            .frame(width: 40, height: 40)
                                        Text("Fat: \(eatenToday.fatToday, specifier: "%0.f") g")
                                    }
                                    .shadow(color: Color("LightShadow"), radius: 12, x: -12, y: -12)
                                    .shadow(color: Color("DarkShadow"), radius: 12, x: 12, y: 12)
                                    .padding(10)
                                    VStack {
                                        Color(self.colorScheme == .light ? .black: .white)
                                            .mask(Image("Fiber")
                                                .resizable())
                                            .frame(width: 40, height: 40)
                                        Text("Fiber: \(eatenToday.fiberToday, specifier: "%0.f") g")
                                    }
                                    .shadow(color: Color("LightShadow"), radius: 12, x: -12, y: -12)
                                    .shadow(color: Color("DarkShadow"), radius: 12, x: 12, y: 12)
                                    .padding(10)
